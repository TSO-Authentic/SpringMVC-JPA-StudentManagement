		...
		<div id="main_contents">
			<div id="contents">
				...
				<form:form name="registerForm"
					action="/SpringMVC-JPA-StudentManagement/updateUser" method="post"
					...
					<table class="tableForm">
						<tr>
							...
							<td class="tblSingleInput"><form:input type="text"
									...
									readonly="true" /><form:errors path="id" style="color:red;"></form:errors></td>
						</tr>
						<tr>
							<td class="tblSingleLabel">User Name</td>
							<td class="tblSingleInput"><form:input type="text"
									class="txtlong_popup" id="txtUserName" path="name" /><form:errors path="name" style="color:red;"></form:errors></td>
						</tr>
						<tr>
							<td class="tblSingleLabel">Password *</td>
							<td class="tblSingleInput"><form:input type="password"
									class="txtlong_popup" id="txtUserName" path="password" /> <form:errors
									path="password" style="color:red;"></form:errors></td>
						</tr>
						<tr>
							<td class="tblSingleLabel">Confirm Password *</td>
							<td class="tblSingleInput"><form:input type="password"
									class="txtlong_popup" id="txtUserName" path="confirm" />
								<form:errors path="confirm" style="color:red;"></form:errors></td>
						</tr>
					</table>
					<br />
					<input type="submit" value="Update" class="button" />
					<input type="button" value="Back" class="button"
						onclick="window.location.replace('/SpringMVC-JPA-StudentManagement/setupUser')" />
				</form:form>
